...
export const PE_ACCOUNTS: ChartAccount[] = [
  { code: '200', name: 'Sales Revenue', type: 'Revenue', taxCode: 'PEI - HST on Sales (15%)', description: 'Income from the sale of products.' },
  { code: '220', name: 'Service Revenue', type: 'Revenue', taxCode: 'PEI - HST on Sales (15%)', description: 'Income from performing services.' },
  ...
  { code: '310', name: 'Cost of Goods Sold', type: 'Direct Costs', taxCode: 'PEI - HST on Purchases (15%)', description: 'Cost of goods sold by the business' },
  ...
  { code: '315', name: 'Subcontractors', type: 'Direct Costs', taxCode: 'PEI - HST on Purchases (15%)', description: 'Payments to subcontractors' },
  { code: '400', name: 'Advertising', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred for advertising while trying to increase sales' },
  ...
  { code: '408', name: 'Cleaning', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred for cleaning business property.' },
  ...
  { code: '420', name: 'Entertainment', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Business-related entertainment expenses that are 50% deductible for income tax purposes.' },
  { code: '421', name: 'Entertainment - Alcohol Purchases', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Record business-related alcohol purchases; 50% tax deductible.' },
  { code: '425', name: 'Freight & Courier', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred on courier & freight costs' },
  ...
  { code: '441', name: 'Legal expenses', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred on any legal matters' },
  { code: '442', name: 'Electricity', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred for electricity use' },
  { code: '445', name: 'Natural Gas Expense', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred for heating provided by natural gas' },
  ...
  { code: '449', name: 'Motor Vehicle Expenses', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred on the running of company motor vehicles' },
  { code: '450', name: 'Motor Vehicle Expenses - PST Exempt', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred on the running of company motor vehicles that are PST exempt' },
  { code: '453', name: 'Office Expenses', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'General expenses related to the running of the business office.' },
  { code: '455', name: 'Supplies and Small Tools', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Supplies and small tools purchases (less than $500 per item) for running the business' },
  { code: '461', name: 'Printing & Stationery', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred by the entity as a result of printing and stationery' },
  { code: '468', name: 'Commercial Rent', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'The payment to lease commercial space' },
  ...
  { code: '473', name: 'Repairs and Maintenance', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred on a damaged or run down asset that will bring the asset back to its original condition.' },
  ...
  { code: '479', name: 'Uniforms', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Purchase and maintenance of uniforms' },
  ...
  { code: '485', name: 'Subscriptions', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'E.g. Magazines, professional bodies' },
  { code: '487', name: 'Training and Continuing Education', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Training seminars and other professional continuing education programs' },
  { code: '489', name: 'Telephone & Internet', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenditure incurred from any business-related phone calls, phone lines, or internet connections' },
  { code: '493', name: 'Travel - National', type: 'Expense', taxCode: 'PEI - HST on Purchases (15%)', description: 'Expenses incurred from domestic travel which has a business purpose' },
  ...
  { code: '710', name: 'Equipment', type: 'Fixed Asset', taxCode: 'PEI - HST on Purchases (15%)', description: 'Office equipment that is owned and controlled by the business' },
  ...
  { code: '714', name: 'Vehicles', type: 'Fixed Asset', taxCode: 'PEI - HST on Purchases (15%)', description: 'Vehicles that are owned and controlled by the business' },
  ...
  { code: '720', name: 'Computer Equipment', type: 'Fixed Asset', taxCode: 'PEI - HST on Purchases (15%)', description: 'Computer equipment that is owned and controlled by the business' },
