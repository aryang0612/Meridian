...
export const QC_ACCOUNTS: ChartAccount[] = [
  ...
  { code: '315', name: 'Subcontractors', type: 'Direct Costs', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Payments to subcontractors' },
  ...
  { code: '408', name: 'Cleaning', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred for cleaning business property.' },
  ...
  { code: '420', name: 'Entertainment', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Business-related entertainment expenses that are 50% deductible for income tax purposes.' },
  { code: '421', name: 'Entertainment - Alcohol Purchases', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Record business-related alcohol purchases; 50% tax deductible.' },
  { code: '425', name: 'Freight & Courier', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred on courier & freight costs' },
  ...
  { code: '441', name: 'Legal expenses', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred on any legal matters' },
  { code: '442', name: 'Electricity', type: 'Expense', taxCode: 'QC - GST on Purchases (5%)', description: 'Expenses incurred for electricity use' },
  { code: '445', name: 'Natural Gas Expense', type: 'Expense', taxCode: 'QC - GST on Purchases (5%)', description: 'Expenses incurred for heating provided by natural gas' },
  ...
  { code: '449', name: 'Motor Vehicle Expenses', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred on the running of company motor vehicles' },
  { code: '450', name: 'Motor Vehicle Expenses - PST Exempt', type: 'Expense', taxCode: 'QC - GST on Purchases (5%)', description: 'Expenses incurred on the running of company motor vehicles that are PST exempt' },
  ...
  { code: '455', name: 'Supplies and Small Tools', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Supplies and small tools purchases (less than $500 per item) for running the business' },
  { code: '461', name: 'Printing & Stationery', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred by the entity as a result of printing and stationery' },
  { code: '468', name: 'Commercial Rent', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'The payment to lease commercial space' },
  ...
  { code: '473', name: 'Repairs and Maintenance', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred on a damaged or run down asset that will bring the asset back to its original condition.' },
  ...
  { code: '479', name: 'Uniforms', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Purchase and maintenance of uniforms' },
  ...
  { code: '485', name: 'Subscriptions', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'E.g. Magazines, professional bodies' },
  { code: '487', name: 'Training and Continuing Education', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Training seminars and other professional continuing education programs' },
  { code: '489', name: 'Telephone & Internet', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenditure incurred from any business-related phone calls, phone lines, or internet connections' },
  { code: '493', name: 'Travel - National', type: 'Expense', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Expenses incurred from domestic travel which has a business purpose' },
  ...
  { code: '710', name: 'Equipment', type: 'Fixed Asset', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Office equipment that is owned and controlled by the business' },
  ...
  { code: '714', name: 'Vehicles', type: 'Fixed Asset', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Vehicles that are owned and controlled by the business' },
  ...
  { code: '720', name: 'Computer Equipment', type: 'Fixed Asset', taxCode: 'QC - GST/QST on Purchases (14.975%)', description: 'Computer equipment that is owned and controlled by the business' },
